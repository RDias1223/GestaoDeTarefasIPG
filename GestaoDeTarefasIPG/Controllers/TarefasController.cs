...
namespace GestaoDeTarefasIPG.Controllers
{
    public class TarefasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TarefaId,Nome,Prioridade")] Tarefa tarefa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TarefaId,Nome,Prioridade")] Tarefa tarefa)
        {
